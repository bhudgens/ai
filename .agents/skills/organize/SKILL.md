---
name: organize
description: Analyze and restructure a repository for AI-native development by establishing the 5 pillars — root CLAUDE.md, skills, hooks, progressive docs, and local context files. Use when asked to organize a repo for AI, set up CLAUDE.md, or "organize".
---
