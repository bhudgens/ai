---
description: Work with the benvironment project — a personal dev environment bootstrap system. Use for any task involving benvironment files, tools, aliases, functions, configs, or environment setup.
---
